...
function batcoinServiceSchematic(options) {
  return (tree) =>
    __awaiter(this, void 0, void 0, function* () {
      ...
      console.log(`----------- Batcoin Service ${options.name} Created Successfully ----------`);
      return (0, schematics_1.chain)([(0, schematics_1.mergeWith)(templateSource)]);
    });
}
exports.batcoinServiceSchematic = batcoinServiceSchematic;
